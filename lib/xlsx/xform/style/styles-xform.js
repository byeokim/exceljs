  ...
  render(xmlStream, model) {
    ...
    if (this.index) {
      ...
      if (!model.fonts.length) {
        // default (zero) font
        this._addFont({size: 11, color: {theme: 1}, name: '맑은 고딕', family: 2, scheme: 'minor', charset: 129});
      }
...
class StylesXformMock extends StylesXform {
  constructor() {
    ...
    this.model = {
      ...
      numFmts: [],
      fonts: [{size: 11, color: {theme: 1}, name: '맑은 고딕', family: 2, scheme: 'minor', charset: 129}],
      borders: [{}],
      fills: [
